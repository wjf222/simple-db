...
public class Join extends Operator {
    ...
    public String getJoinField1Name() {
        // some code goes here
        return this.child1.getTupleDesc().getFieldName(this.jPre.getField1());
    }
    ...
    public String getJoinField2Name() {
        // some code goes here
        return this.child2.getTupleDesc().getFieldName(this.jPre.getField2());
    }
    ...
    public void setChildren(OpIterator[] children) {
        ...
        this.newTd = TupleDesc.merge(child1.getTupleDesc(),child2.getTupleDesc());
    }
